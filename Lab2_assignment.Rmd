...
ggplot()+
  geom_sf(data = acsTractsPHL.2019.sf, aes(fill = walked_vehiclePct.2019),
          color = "transparent")+
  geom_sf(data = acsTractsPHL.2019.sf %>%
            filter(Neighborhood == "FAIRMOUNT/BREWERYTOWN") %>%
            st_union(),
          color = "white",
          fill = "transparent")+
   labs(
    title = "PERCENTAGE OF THOSE WHO OWNED VEHICLES WHO WALK TO WORK",
    subtitle = "",
